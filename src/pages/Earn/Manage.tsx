...
import { BIG_INT_ZERO, BIG_INT_SECONDS_IN_WEEK, SWAPHIVE } from '../../constants'
...
export default function Manage({
  ...
  const token = currencyA === SWAPHIVE ? tokenB : tokenA
  const WETH = currencyA === SWAPHIVE ? tokenA : tokenB
