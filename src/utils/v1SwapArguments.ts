...
export default function v1SwapArguments(
  ...
  const inputETH = trade.inputAmount.currency === SWAPHIVE
  const outputETH = trade.outputAmount.currency === SWAPHIVE
  if (inputETH && outputETH) throw new Error('SWAPHIVE to SWAPHIVE')
